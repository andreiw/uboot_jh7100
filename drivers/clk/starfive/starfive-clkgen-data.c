...
#define JH7100_GATE(_idx, _name, _flags, _parent) [_idx] = {			\
	.name = _name,								\
	.flags = CLF_GATED | CLF_SET_RATE_PARENT | (_flags),			\
	.max = 0,								\
	.parents = { [0] = _parent },						\
}
...
#define JH7100_GDIV(_idx, _name, _flags, _max, _parent) [_idx] = {		\
	.name = _name,								\
	.flags = CLF_DIV | CLF_GATED | (_flags),				\
	.max = (_max),								\
	.parents = { [0] = _parent },						\
}
...
#define JH7100_GMUX(_idx, _name, _flags, _nparents, ...) [_idx] = {		\
	.name = _name,								\
	.flags = CLF_GATED | CLF_MUXED | (_flags),				\
	.max = (((_nparents) - 1) << JH7100_CLK_MUX_SHIFT),			\
	.parents = { __VA_ARGS__ },						\
}
...
#define JH7100__GMD(_idx, _name, _flags, _max, _nparents, ...) [_idx] = {	\
	.name = _name,								\
	.flags = CLF_DIV | CLF_GATED | CLF_MUXED | _flags,			\
	.max = (((_nparents) - 1) << JH7100_CLK_MUX_SHIFT) | (_max),		\
	.parents = { __VA_ARGS__ },						\
}
...
#define JH7100__INV(_idx, _name, _parent) [_idx] = {				\
	.name = _name,								\
	.flags = CLF_INVERT | CLF_SET_RATE_PARENT,				\
	.max = 0,								\
	.parents = { [0] = _parent },						\
}

#define JH7100__SYN(_idx, _name, _mul, _parent) [_idx] = {			\
	.name = _name,								\
	.flags = CLF_SYNTH,							\
	.max = (_mul),								\
	.parents = { [0] = _parent },						\
...
const struct jh7100_clk_data jh7100_clk_data[] = {
	...
	JH7100_GATE(JH7100_CLK_DOM3AHB_BUS, "dom3ahb_bus", CLF_CRITICAL, JH7100_CLK_AHB_BUS),
	JH7100_GATE(JH7100_CLK_DOM7AHB_BUS, "dom7ahb_bus", CLF_CRITICAL, JH7100_CLK_AHB_BUS),
	JH7100_GATE(JH7100_CLK_U74_CORE0, "u74_core0", CLF_CRITICAL, JH7100_CLK_CPU_CORE),
	JH7100_GDIV(JH7100_CLK_U74_CORE1, "u74_core1", CLF_CRITICAL, 8, JH7100_CLK_CPU_CORE),
	JH7100_GATE(JH7100_CLK_U74_AXI, "u74_axi", CLF_CRITICAL, JH7100_CLK_CPU_AXI),
	JH7100_GATE(JH7100_CLK_U74RTC_TOGGLE, "u74rtc_toggle", CLF_CRITICAL, JH7100_CLK_OSC_SYS),
	...
	JH7100_GDIV(JH7100_CLK_DDRPLL_DIV2, "ddrpll_div2", CLF_CRITICAL, 2, JH7100_CLK_PLL1_OUT),
	JH7100_GDIV(JH7100_CLK_DDRPLL_DIV4, "ddrpll_div4", CLF_CRITICAL, 2, JH7100_CLK_DDRPLL_DIV2),
	JH7100_GDIV(JH7100_CLK_DDRPLL_DIV8, "ddrpll_div8", CLF_CRITICAL, 2, JH7100_CLK_DDRPLL_DIV4),
	JH7100_GDIV(JH7100_CLK_DDROSC_DIV2, "ddrosc_div2", CLF_CRITICAL, 2, JH7100_CLK_OSC_SYS),
	JH7100_GMUX(JH7100_CLK_DDRC0, "ddrc0", CLF_CRITICAL, 4,
		    JH7100_CLK_DDROSC_DIV2,
		    JH7100_CLK_DDRPLL_DIV2,
		    JH7100_CLK_DDRPLL_DIV4,
		    JH7100_CLK_DDRPLL_DIV8),
	JH7100_GMUX(JH7100_CLK_DDRC1, "ddrc1", CLF_CRITICAL, 4,
		    JH7100_CLK_DDROSC_DIV2,
		    JH7100_CLK_DDRPLL_DIV2,
		    JH7100_CLK_DDRPLL_DIV4,
		    JH7100_CLK_DDRPLL_DIV8),
	...
	JH7100_GATE(JH7100_CLK_DSPX2C_AXI, "dspx2c_axi", CLF_CRITICAL, JH7100_CLK_NNE_BUS),
	...
	JH7100_GDIV(JH7100_CLK_X2C_AXI, "x2c_axi", CLF_CRITICAL, 8, JH7100_CLK_CPUNBUS_ROOT_DIV),
	...
	JH7100__SYN(JH7100_CLK_PLL0_OUT, "pll0_out", 40, JH7100_CLK_OSC_SYS),
	JH7100__SYN(JH7100_CLK_PLL1_OUT, "pll1_out", 64, JH7100_CLK_OSC_SYS),
	JH7100__SYN(JH7100_CLK_PLL2_OUT, "pll2_out", 55, JH7100_CLK_PLL2_REF)
};
