...
#if CONFIG_IS_ENABLED(ETH_DESIGNWARE_FIXED_BUFF)
#define TX_MAC_DES	fixed_tx_mac_descrtable
#define RX_MAC_DES	fixed_rx_mac_descrtable
#define TX_BUFF	fixed_txbuffs
#define RX_BUFF	fixed_rxbuffs
struct dmamacdescr *fixed_tx_mac_descrtable =
	(struct dmamacdescr *)CONFIG_ETH_DESIGNWARE_FIXED_TX_MAC_DES_BASE;
struct dmamacdescr *fixed_rx_mac_descrtable =
	(struct dmamacdescr *)CONFIG_ETH_DESIGNWARE_FIXED_RX_MAC_DES_BASE;
char *fixed_txbuffs = (char *)CONFIG_ETH_DESIGNWARE_FIXED_TXBUFF_BASE;
char *fixed_rxbuffs = (char *)CONFIG_ETH_DESIGNWARE_FIXED_RXBUFF_BASE;
#else
